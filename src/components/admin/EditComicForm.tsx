            ...
            <form onSubmit={handleUpdateComic} className="admin-form">
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            ...
                            <div style={{ display: 'flex', gap: '10px' }}>
                                ...
                                <button 
                                    ...
                                    style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', backgroundColor: '#3498db', color: 'white', border: 'none' }}
                                >
                                    <FiDownload /> Tải về
                                </button>
                            </div>
                            ...
                            <small style={{ color: '#666' }}>
                                {coverImageFile ? `Đã chọn: ${coverImageFile.name}` : 'Ảnh hiện tại đang được sử dụng'}
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div className="form-actions">
                    ...
                    <button
                        ...
                        disabled={isSubmitting || isDeleting}
                    >
                        {isDeleting ? 'Đang xóa...' : <><FiTrash2 /> Xóa Truyện Này</>}
                    </button>
                </div>
            </form>
        </div>
