...
const DailyRewardModal: React.FC<DailyRewardModalProps> = ({ isOpen, onClose }) => {
	...
	const todayRewardIndex = isTodayClaimed
		? (currentStreak - 1) % dailyRewardsData.length
		: currentStreak % dailyRewardsData.length;
			...
			<div className="daily-modal-container">
				...
				<div className="daily-modal-header">
					...
					<div className="streak-badge">
						<span>
							Chuỗi hiện tại: <strong>{currentStreak} Ngày</strong>
						</span>
					</div>
				</div>
					...
					{displayedRewards.map((reward, index) => (
						...
						>
							...
							<div className="reward-visual">
								...
								/>
								{reward.type !== 'Xu' && (
									<FiGift className="reward-fallback-icon" />
								)}
