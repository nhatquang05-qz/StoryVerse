                    ...
                    <>
                        <div className="profile-header-section">
                            ...
                            <div className="profile-meta">
                                <span><FiActivity /> Cấp {profile.level}</span>
                                <span><FiCalendar /> Tham gia: {new Date(profile.joinDate).toLocaleDateString('vi-VN')}</span>
                            </div>
                        </div>

                        <div className="profile-body-section">
                            <h3><FiMessageCircle style={{marginRight: '8px', verticalAlign: 'middle'}}/>Bình luận gần đây</h3>
                            {profile.recentComments && profile.recentComments.length > 0 ? (
                                <div className="recent-reviews-list">
                                    {profile.recentComments.map(comment => (
                                        <div key={comment.id} className="review-mini-item">
                                            <img src={comment.comicCover} alt="comic" className="review-comic-cover" />
                                ...
                                <p className="no-activity">Chưa có bình luận nào trong các chapter.</p>
                            )}
                        </div>
                    </>
                ) : (
