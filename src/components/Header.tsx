...
const Header: React.FC = () => {
    ...
    const handleCommunityClick = (e: React.MouseEvent) => {
        if (!currentUser) {
            e.preventDefault();
            showToast('Vui lòng đăng nhập để tham gia cộng đồng', 'warning');
    ...
    const handleNotificationClick = async (notif: Notification) => {
        ...
        if (notif.type === 'COMIC' && notif.referenceId) {
            navigate(`/comic/${notif.referenceId}`);
