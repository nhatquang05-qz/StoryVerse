	...
	return (
		<div className="popup-overlay" onClick={onClose}>
			<div
				...
				style={{ borderColor: levelColor, boxShadow: `0 0 15px ${levelColor}` }}
			>
				<button className="popup-close-btn" onClick={onClose}>
					<FiX />
				</button>
				<FiAward className="popup-icon" style={{ color: levelColor }} />
				<h2 className="popup-title" style={{ color: levelColor }}>
					Chúc Mừng Lên Cấp!
				</h2>
				<p className="popup-message">Bạn đã đạt đến cấp độ mới:</p>
				<p
