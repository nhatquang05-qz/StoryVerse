  ...
  return (
    <div className="popup-overlay" onClick={onClose}>
      <div className="popup-content success-popup" onClick={(e) => e.stopPropagation()} style={{ borderColor: 'var(--clr-error-text)', boxShadow: `0 0 15px var(--clr-error-border)` }}>
        ...
        <h2 className="popup-title" style={{ color: 'var(--clr-error-text)' }}>Cảnh Báo Ngôn Từ</h2>
        <p className="popup-message">
          Tin nhắn của bạn chứa từ ngữ không phù hợp.
        </p>
        <p className="popup-message">
          Vui lòng sử dụng ngôn từ lịch sự khi trò chuyện.
        </p>
