        ...
        <div className="post-item">
            <div className="post-header">
                ...
                <div className="post-options-wrapper">
                    <button className="btn-options" onClick={(e) => { e.stopPropagation(); setActiveMenuId(showMenu ? null : {id: post.id, type: 'post'}); }}>
                        <FaEllipsisH />
                    </button>
                    {showMenu && (
            ...
            <div className="post-actions-bar">
                <button className={`post-action-btn ${post.isLiked ? 'liked' : ''}`} onClick={() => onLike(post)}>
                ...
                <button className="post-action-btn" onClick={() => {navigator.clipboard.writeText(window.location.href); alert('Đã sao chép liên kết!')}}>
