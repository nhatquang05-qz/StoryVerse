...
const AdminPage: React.FC = () => {
	...
	const renderContent = () => {
		...
		switch (activeView) {
			...
			case 'chapters':
				return selectedComic ? (
					<ManageChapters comic={selectedComic} onCancel={handleFormCancel} />
				) : (
					<p>Lỗi</p>
				);
			...
			case 'physical':
				return (
					<>
						...
						{filterBar}
						<ComicManagementList
							comics={physicalComics}
							onEdit={handleSelectEdit}
							onDelete={handleDeleteComic}
							onManageChapters={handleSelectChapters}
						/>
					</>
				);
			case 'digital':
	...
	return (
		<div className="admin-dashboard-layout">
			...
			<div className="admin-main-wrapper">
				...
				<main className="admin-content-scrollable">{renderContent()}</main>
			</div>
		</div>
	);
};
