...
const ReaderPage: React.FC = () => {
    ...
    // HÀM MỚI: Xử lý Mở khóa và Chuyển hướng
    const handleUnlockAndNavigate = async () => {
        ...
        try {
            ...
            // CHUYỂN HƯỚNG THẲNG ĐẾN CHƯƠNG VỪA MỞ KHÓA
