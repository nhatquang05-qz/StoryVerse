...
const ReaderPage: React.FC = () => {
    ...
    const [chapterImages, setChapterImages] = useState<string[]>([]); // Sẽ lấy từ mockData
    ...
    useEffect(() => {
        ...
        if (foundChapter.images && foundChapter.images.length > 0) {
            setChapterImages(foundChapter.images);
        } else {
            setChapterImages([`https://via.placeholder.com/800x1200?text=${encodeURIComponent(comic.title)}+Chap+${foundChapter.chapterNumber}+Page+1+(No+Images)`]);
        }
