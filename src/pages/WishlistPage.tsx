        ...
        return (
            <div className="wishlist-page-container">
                <div className="wishlist-empty-state login-required">
                    ...
                    <p className='wlp'>Vui lòng đăng nhập để đồng bộ và xem danh sách truyện yêu thích của bạn.</p>
            ...
            <div className="wishlist-content">
                {wishlistCount > 0 ? (
                    ...
                    <div className="wishlist-empty-state">
                        ...
                        <p>Bạn chưa lưu bộ truyện nào. Hãy khám phá và thả tim cho những bộ truyện bạn thích nhé!</p>
