...
const coreValues = [
	{
		title: 'Đam Mê',
		desc: 'Chúng tôi sống và thở cùng truyện tranh, mang đến những câu chuyện chạm đến trái tim.',
		icon: Heart,
		colorClass: 'bg-red-light',
	},
	{
		title: 'Sáng Tạo',
		desc: 'Nơi trí tưởng tượng không có giới hạn, ủng hộ các tác giả trẻ vươn tầm thế giới.',
		icon: Zap,
		colorClass: 'bg-yellow-light',
	},
	{
		title: 'Kết Nối',
		desc: 'Xây dựng cộng đồng văn minh, nơi độc giả và tác giả cùng chia sẻ cảm xúc.',
		icon: Users,
		colorClass: 'bg-blue-light',
	},
	{
		title: 'Chất Lượng',
		desc: 'Trải nghiệm đọc mượt mà, hình ảnh sắc nét và bản quyền minh bạch.',
		icon: Target,
	...
	return (
		<div className="about-container">
			<div className="hero-section" ref={ref}>
				...
				<motion.div style={{ y, opacity }} className="hero-content">
					...
					<p className="hero-subtitle">
						Nơi những câu chuyện trở nên sống động và cảm xúc được thăng hoa.
					</p>
				</motion.div>
			...
			<div className="relative z-20">
					...
					<div className="story-grid">
						<InViewAnimation delay={0.1}>
							...
							<p className="story-text">
								StoryVerse không chỉ là một website, đó là giấc mơ của những con
								người yêu truyện tranh. Chúng tôi bắt đầu từ một căn phòng nhỏ với
								niềm tin rằng truyện tranh Việt Nam và thế giới cần một cầu nối hiện
								đại hơn.
							</p>
							<p className="story-text">
								Tại đây, chúng tôi tôn trọng bản quyền, tôn vinh tác giả và trân
								trọng từng độc giả. Mỗi trang truyện bạn đọc là một sự ủng hộ to lớn
								đối với cộng đồng sáng tạo.
							</p>
						</InViewAnimation>
				...
				<section
					className="founder-section section-container"
					style={{
					...
					<div className="founder-content-wrapper">
						...
						<InViewAnimation delay={0.4} className="founder-info">
							...
							<blockquote className="founder-quote">
								"Tôi tạo ra StoryVerse không chỉ để bán truyện tranh, mà để tạo ra
								một vũ trụ nơi trí tưởng tượng được tôn vinh. Mỗi dòng code là một
								viên gạch xây dựng nên giấc mơ này."
							</blockquote>
							<a
					...
					<InViewAnimation delay={0.1}>
						...
						>
							...
							<p className="cta-subtitle">
								Tham gia cộng đồng StoryVerse ngay hôm nay để mở khóa hàng ngàn bộ
