		...
		return (
			<div className="top-comics-list">
				{topComics.map((comic, index) => {
					...
					if (index === 0) {
						rankDisplay = (
							<img src={top1Image} alt="Top 1" className="rank-comic-image rank-1" />
						);
					} else if (index === 1) {
						rankDisplay = (
							<img src={top2Image} alt="Top 2" className="rank-comic-image rank-2" />
						);
					} else if (index === 2) {
						rankDisplay = (
							<img src={top3Image} alt="Top 3" className="rank-comic-image rank-3" />
						);
					} else {
						rankDisplay = (
							...
							<div className="comic-info">
								...
								<div className="comic-meta">
									...
									<span className="view-count">
										{formatViewCountSimple(comic.viewCount)} lượt xem
									</span>
								</div>
							</div>
						</Link>
