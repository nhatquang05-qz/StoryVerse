							...
							{transactions.map((item) => (
								<tr key={item.id}>
									...
									<td style={{ textAlign: 'center' }}>
										<span
											className={`transaction-badge ${item.type === 'RECHARGE' ? 'badge-recharge' : 'badge-purchase'}`}
										>
									...
									<td
										className={`col-amount ${item.type === 'RECHARGE' ? 'amount-plus' : 'amount-minus'}`}
									>
										{item.type === 'RECHARGE' ? '+' : '-'}
									...
									<td style={{ textAlign: 'center' }}>
										<span
											className={`transaction-badge ${item.status === 'SUCCESS' ? 'status-success' : 'status-failed'}`}
										>
