...
const LevelSystemSelector: React.FC<LevelSelectorProps> = ({
	currentUserLevel,
	currentSystemKey,
	onSystemChange,
	currentLevelColor,
		...
		<div className="level-system-selector-wrapper" ref={selectorRef}>
			<div className="system-current-info">
				...
				{!isEditing ? (
					<>
						...
						>
							{liveSystem.name}{' '}
							<FiHelpCircle style={{ verticalAlign: 'middle', marginLeft: '4px' }} />
						</span>
						<button
			...
			<div className="equivalent-level-display">
				...
				<span
					...
					style={{ fontWeight: 'bold', color: 'var(--clr-text)' }}
				>
					{equivalentLevel}
				</span>
			</div>
			...
			{isEditing && (
				<div className="system-info-editing">
					<p className="system-description">**Mô tả:** {liveSystem.description}</p>
