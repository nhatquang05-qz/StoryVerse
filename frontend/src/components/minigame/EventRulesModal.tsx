		...
		<div className="gift-modal-overlay">
			<div className="rules-modal-content">
				...
				<div className="rules-body">
					...
					<div className="rules-section-title title-red">🎁 1. Hộp Quà Bí Ẩn</div>
					<p>
						Mỗi lượt mở quà tốn <strong>20 Xu</strong> hoặc{' '}
						<strong>1 lượt quay miễn phí</strong>.
					</p>
					...
					<div className="rules-section-title title-green">🎄 2. Cây Thông Lời Chúc</div>
					<p>
						Mỗi ngày bạn được gửi <strong>1 lời chúc miễn phí</strong> lên cây thông.
					</p>
					<p>
						Khi gửi lời chúc thành công, bạn sẽ nhận được một lượng Xu ngẫu nhiên từ hệ
						thống.
					</p>
				</div>
			</div>
